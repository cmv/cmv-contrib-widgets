...
| [Google Analytics](https://github.com/jebu75/cmv-google-analytics) | Title pane widget to allow swapping in/out a configurable list of dynamic or tile layers. |
